    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$asesor->phone}}</td>
                <td>
                    <!-- <button wire:click.prevent="resetForm('{{$asesor->id}}')" class="btn btn-xs btn-warning mr-2 btn-reset" data-toggle="modal" data-target="#reset-password-form">Reset password</button> -->
                </td>
            </tr>
            @endforeach
        </tbody>
