<div wire:ignore.self class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="create-asesor-modal" aria-hidden="true" id="update-skema-modal">
            ...
            <div class="modal-body">
                ...
                <div class="form-group clearfix">
                    <div class="icheck-primary d-inline">
                        <input type="radio" wire:click="toggleStatus('y')" id="statusRadio1" name="gender">
                        <label for="radioPrimary1">
                            Active
                        </label>
                    </div>
                    <div class="icheck-primary d-inline">
                        <input type="radio" wire:click="toggleStatus('n')" id="statusRadio2" name="gender">
