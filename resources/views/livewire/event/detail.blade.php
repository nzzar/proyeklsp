...
<div class="container-fluid">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input wire:model="qty" @if(!in_array($status, ['Draft', 'Unapproved' ])) disabled @endif type="number" class="form-control  @error('qty') is-invalid @enderror" placeholder="Masukan Jumlah Kuota Peserta">
                            @error('qty') <span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tempat Uji Kompetensi (TUK)</label>
                            <input wire:model="tuk" @if(!in_array($status, ['Draft', 'Unapproved' ])) disabled @endif type="text" class="form-control  @error('nik') is-invalid @enderror" placeholder="Masukan TUK">
    ...
    @if($tabActive == 'report')
    @livewire('event.laporan', ['id' => $eventId])
    @endif
</div>
